...
import app.getgainz.service.crud.HistoryCrudService;
    ...
    public List<HistoryResponseDTO> readAll(@PathVariable("date") String strDate,
        ...
        if (strDate != null) {
            try {
                ...
                throw new GetGainzException(DATE_NOT_VALID);
            }
            Integer userId = appUserPrincipal.getId();
            if (userId != null) {
    ...
    public void update(@PathVariable("id") @NotNull Integer historyId,
        ...
        if (userId != null) {
        	...
        	if (historyResponseDTO != null && historyResponseDTO.getAppUserId().equals(userId)) {
        		...
        		throw new GetGainzException("UserIds doesn't match. Cannot update others History.");
        	}            
        }
    }
    ...
    public void delete(@PathVariable("id") @NotNull Integer historyId,
        ...
        if (userId != null) {
            ...
            if (historyResponseDTO != null && historyResponseDTO.getAppUserId().equals(userId)) {
                ...
                throw new GetGainzException("UserIds doesn't match. Cannot delete others History.");
            }
        }
    }
}
