...
import app.getgainz.testhelper.ExerciseTestHelper;
...
class ExerciseCrudServiceTest {
	...
	class Create {
		...
		void nameAlreadyExists_throwFitBuddyException() {
			...
			assertThrows(GetGainzException.class, () -> exerciseCrudService.create(requestDTO));
		}
	...
	class Update {
		...
		void nameAlreadyExists_throwFitBuddyException() {
			...
			assertThrows(GetGainzException.class, () -> exerciseCrudService.update(1, updateDTO));
		}
